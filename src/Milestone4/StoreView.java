...
public class StoreView {
    ...
    public StoreView(StoreManager storeMan) {
        ...
        this.tempItems.put(1,storeMan.getInventory().getStock(1));
        this.tempItems.put(2,storeMan.getInventory().getStock(2));
        this.tempItems.put(3,storeMan.getInventory().getStock(3));
        this.tempItems.put(4,storeMan.getInventory().getStock(4));
        this.tempItems.put(5,storeMan.getInventory().getStock(5));
    }
